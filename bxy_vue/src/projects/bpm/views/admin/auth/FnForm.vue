  ...
  <n-form ref="formRef" :model="model" :rules="rules" label-placement="left">
    <n-grid :cols="24" :x-gap="24">
      ...
      <n-form-item-gi :span="12" label="授权菜单" path="menucode">
        <n-tree-select v-model:value="prop.mcode" :options="menuOptions" :key-field="'guid'" :label-field="'mname'"
          placeholder="请选择菜单" @update:value="handleUpdateMenu" />
      </n-form-item-gi>
      <n-form-item-gi :span="24" label="授权功能" path="mcode">
        <n-checkbox-group v-model:value="model.mcodes">
          <n-space item-style="display: flex;">
            <n-checkbox v-for="(fn, key) in fns" :key="key" :value="fn.guid" :label="fn.mname" />
          </n-space>
        </n-checkbox-group>
      </n-form-item-gi>
