<template>
  <n-form ref="formRef" :model="model" :rules="rules" label-placement="left">
    <n-grid :cols="24" :x-gap="24">
      ...
      <n-form-item-gi :span="24" label="授权字段" path="field">
        <n-input v-model:value="model.field" placeholder="请输入列级授权字段名" />
      </n-form-item-gi>
      <n-form-item-gi :span="24" label="授权规则" path="regx">
        <n-input v-model:value="model.regx" placeholder="请输入列级授权规则" />
      </n-form-item-gi>
      ...
      <n-form-item-gi :span="24" label="备注说明" path="remark">
        <n-input v-model:value="model.remark" placeholder="请输入列级授权相关备注说明" type="textarea" :autosize="{
          minRows: 2,
          maxRows: 3,
        }" />
      </n-form-item-gi>
